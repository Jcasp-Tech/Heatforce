...
import { electricityBillCalculationAPI, energyGenerationCalculationAPI, getSFFactorByDirectionsAPI, getWebLeadCalculationAPI, updateUserInfoQuoteWebLeadDataAPI, usableEnergyProducedCalculationAPI } from '@/redux/services/general.api';
...
export interface BatteryComboPackageProps {
    quoteData: any;
...
export const BatteryComboPackage2 = (props: BatteryComboPackageProps) => {
    const {
        quoteData,
        setDisableScroll,
        changePopupData,
    ...
    useEffect(() => {
        if (quoteData.solar_system_size) {
            if (quoteData.solar_system_size && OBJCOMBO?.battery_more?.length) {
                ...
                // Find the first battery variant where battery_kWh is greater than solar_system_size
                const selectedBattery = batteryVariants.find((battery) => battery.battery_kWh >= quoteData.solar_system_size);


                // If a valid battery variant is found, set it to the state
                if (selectedBattery) {
                    setBateryVariant(selectedBattery); // Set the whole battery object
                } else {
                    setBateryVariant(batteryVariants[0]); // If no battery variant is suitable, set null
                }
            }
        }
    }, [quoteData.solar_system_size])
        ...
        try {
            ...
            if (
                ...
                if (leadCalculation) {
                    ...
                    if (estimatedEnnualUsableEnergy) {
                        ...
                        const exportEarningFactor = AverageOfPeakFluxDayRate
            ...
            setNewquoteData((prevState: any) => {
                return {
                    ...
                    battery_brand: OBJCOMBO?.battery_brand_name
                };
            });
    ...
    const saveCurrentPackageInfo = useCallback(async (quoteData) => {
        ...
        let dataToSave = {
            ...
            battery_brand: batteryVariant?.battery_brand_name || ""
        };
                    ...
                    <div className="topLine">
                        ...
                        {index === 1 && (
                            <div className="mainHeading col-11">{quoteData?.leadData?.lead_status === "CONFIRM" ?
                                ...
                                <><span className="font34Green">SECOND PICK: </span>
                                    <span className="valign">
                                        More affordable | Earn a Little Less
                                    </span></>}
                            </div>
                        )}
                    </div>
                    <div className={`heading${1} comboHeading${1} col-11`}>
                        <div className='mb-4'>
                            <p className='chooseBatteryText'>Choose the battery size you need</p>
                            <div className='d-flex flex-row align-items-center gapForBatteryPackages chooseButtonBatteryCombo2'>
                                <div className=
                                    {batteryVariant?.battery_kWh === comboBatteryVariants?.[0]?.battery_kWh ? 'BatteryOnlyVariantBoxSelected BatteryVariantWithOfferPadding borderRadius18' : 'BatteryOnlyVariantBox BatteryVariantWithOfferPadding borderRadius18'}
                                    onClick={() => {
                                ...
                                >
                                    <div className="col-12 mt-11 text-center px-1 cursor-pointer">
                                        <div className="col-12 mt-11 text-center">
                                            ...
                                            <div className={batteryVariant?.battery_kWh === comboBatteryVariants?.[0]?.battery_kWh ? "font15Selected lineHeight15 mt-2" : "font15-battery lineHeight15 mt-2"}>
                                                {comboBatteryVariants?.[0]?.battery_kWh}KWh
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className={batteryVariant?.battery_kWh === comboBatteryVariants?.[1]?.battery_kWh ? 'BatteryOnlyVariantBoxSelected BatteryVariantWithOfferPadding borderRadius18' : 'BatteryOnlyVariantBox BatteryVariantWithOfferPadding borderRadius18'}
                                    onClick={() => {
                                    ...
                                    <div className="col-12 mt-11 text-center px-1 cursor-pointer">
                                        <div className="col-12 mt-11 text-center">
                                            ...
                                            <div className={batteryVariant?.battery_kWh === comboBatteryVariants?.[1]?.battery_kWh ? "font15Selected lineHeight15 mt-2" : "font15-battery lineHeight15 mt-2"}>
                                                {comboBatteryVariants?.[1]?.battery_kWh}KWh
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className=
                                    {batteryVariant?.battery_kWh === comboBatteryVariants?.[2]?.battery_kWh ? 'BatteryOnlyVariantBoxSelected BatteryVariantWithOfferPadding borderRadius18' : 'BatteryOnlyVariantBox BatteryVariantWithOfferPadding borderRadius18'}
                                    onClick={() => {
                                    ...
                                    <div className="col-12 mt-11 text-center px-1 cursor-pointer">
                                        <div className="col-12 mt-11 text-center">
                                            ...
                                            <div className={batteryVariant?.battery_kWh === comboBatteryVariants?.[2]?.battery_kWh ? "font15Selected lineHeight15 mt-2" : "font15-battery lineHeight15 mt-2"}>
                                                {comboBatteryVariants?.[2]?.battery_kWh}KWh
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="col-6 comboImageWrapper position-relative ">
                            <div className="d-flex ml-5 flex-column logoImgDiv">
                                <div className="mb-2 iconNone">
                                    <Image quality={100}
                                        src={batteryVariant?.battery_brand_image?.path}
                                        alt="dasolarLogo"
                                        width={250}
                                        height={150}
                                    />
                                ...
                                <div className="mt-logo brand-tag-work-with-icon">
                                    <Image quality={100}
                                        src={batteryVariant?.battery_brand_tag_image?.path}
                                        className="workWith"
                                        alt="jiffy"
                                        width={150}
                                        height={150}
                                ...
                                <div className='d-flex flex-row lg:flex-row justify-content-center gap-2'>
                                    ...
                                    >
                                        <div className="col-12 mt-11 text-center px-1 cursor-pointer">
                                            <div className="col-12 mt-11 text-center">
                                                <div className={batteryVariant?.battery_kWh === comboBatteryVariants?.[0]?.battery_kWh ? 'font11BlueSelected mb-1' : 'font11Blue mb-1'}>{batteryVariant?.battery_brand_name}</div>
                                                <div className={batteryVariant?.battery_kWh === comboBatteryVariants?.[0]?.battery_kWh ? "font25Selected lineHeight22 mt-2" : "font25 lineHeight22 mt-2"}>
                                                    {comboBatteryVariants?.[0]?.battery_kWh}KWh
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className={batteryVariant?.battery_kWh === comboBatteryVariants?.[1]?.battery_kWh ? 'BatteryVariantBoxSelected BatteryVariantWithOfferPadding borderRadius18' : 'BatteryVariantBox BatteryVariantWithOfferPadding borderRadius18'}
                                        ...
                                        <div className="col-12 mt-11 text-center px-1 cursor-pointer">
                                            <div className="col-12 mt-11 text-center">
                                                <div className={batteryVariant?.battery_kWh === comboBatteryVariants?.[1]?.battery_kWh ? 'font11BlueSelected mb-1' : 'font11Blue mb-1'}>{batteryVariant?.battery_brand_name}</div>
                                                <div className={batteryVariant?.battery_kWh === comboBatteryVariants?.[1]?.battery_kWh ? "font25Selected lineHeight22 mt-2" : "font25 lineHeight22 mt-2"}>
                                                    {comboBatteryVariants?.[1]?.battery_kWh}KWh
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className=
                                        ...
                                        <div className="col-12 mt-11 text-center px-1 cursor-pointer">
                                            <div className="col-12 mt-11 text-center">
                                                <div className={batteryVariant?.battery_kWh === comboBatteryVariants?.[2]?.battery_kWh ? 'font11BlueSelected mb-1' : 'font11Blue mb-1'}>{batteryVariant?.battery_brand_name}</div>
                                                <div className={batteryVariant?.battery_kWh === comboBatteryVariants?.[2]?.battery_kWh ? "font25Selected lineHeight22 mt-2" : "font25 lineHeight22 mt-2"}>
                                                    {comboBatteryVariants?.[2]?.battery_kWh}KWh
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className='comboNewBtnGreen viewFullBreakdownBorderRadius2 mt-4 z-0 w-100'>
                                <button
                                    ...
                                    onClick={() => {
                                        ...
                                        changePopupData(comboName);
                                        setOpeningModalName((prev) => {
                                            let newarr = prev.filter((name) => name !== modalEnum.closeBatteryOnlyResultPagePopup)
                                            return [...newarr, modalEnum.openBatteryOnlyResultPagePopup]
                                        });
                    ...
                    <div className="col-12 col-md-12 col-lg-12 px-0 estimateCardDivmxAuto mx-auto mt-4">
                        <div className="row g-3 estimateCardDiv">
                            ...
                            <div className="col-12 col-md-6 col-xl-6 order-3 order-xl-3">
                                <div className="grayBox borderRadius18 grayBoxFlex greenBoxMob cursorPointer"
                                    onClick={() => {
                                        changePopupData(comboName);
                                        setOpeningModalName((prev) => {
                                            let newarr = prev.filter((name) => name !== modalEnum.closeFinanceCalculatorPopup)
                        ...
                        <div className="comboNewBtnGreen1 estimateDiv">
                            ...
                            <div className="mt-4 lightBtn align-items-center">
                                ...
                                <div className="newLightBox borderRadius18 newLightBoxMob2 cursorPointer"
                                    onClick={() => {
                                        changePopupData(comboName);
                                        setOpeningModalName((prev) => {
                                            let newarr = prev.filter((name) => name !== modalEnum.closeFinanceCalculatorPopup)
