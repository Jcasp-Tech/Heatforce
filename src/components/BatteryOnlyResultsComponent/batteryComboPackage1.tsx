...
export const BatteryComboPackage1 = (props: BatteryComboPackageProps) => {
    const {
        quoteData,
        setDisableScroll,
        changePopupData,
    ...
    useEffect(() => {
        if (quoteData.solar_system_size) {
            if (quoteData.solar_system_size && OBJCOMBO?.battery_more?.length) {
                ...
                if (quoteData.leadData.lead_status === "CONFIRM") {
                    const batteryVariantForConfirm =
                        batteryVariants.find((battery) => battery.battery_kWh == quoteData.leadData.battery_kWh);

                    setBateryVariant(batteryVariantForConfirm);
                } else {
    ...
    console.log("OBJCOMBO?.battery_more", batteryVariant)
                ...
                <div className="headingWrapper col-12">
                    ...
                    >
                        <div className='mb-4'>
                            ...
                            <div className='d-flex flex-row align-items-center gapForBatteryPackages chooseButtonBatteryCombo1'>
                                <button className=
                                    {batteryVariant?.battery_kWh != comboBatteryVariants?.[0]?.battery_kWh && quoteData.leadData.lead_status === "CONFIRM" ?
                                        'BatteryOnlyVariantBoxDisabled BatteryVariantWithOfferPadding borderRadius18 ' :
                                        batteryVariant?.battery_kWh === comboBatteryVariants?.[0]?.battery_kWh ?
                                            'BatteryOnlyVariantBoxSelected BatteryVariantWithOfferPadding borderRadius18 ' :
                                            'BatteryOnlyVariantBox BatteryVariantWithOfferPadding borderRadius18'}
                                    onClick={() => {
                                        handleBatteryVariantChange(comboBatteryVariants?.[0]?.battery_kWh)
                                    }}
                                    disabled={batteryVariant?.battery_kWh != comboBatteryVariants?.[0]?.battery_kWh && quoteData.leadData.lead_status === "CONFIRM"}
                                >
                                ...
                                <button className=
                                    {batteryVariant?.battery_kWh != comboBatteryVariants?.[1]?.battery_kWh && quoteData.leadData.lead_status === "CONFIRM" ?
                                        'BatteryOnlyVariantBoxDisabled BatteryVariantWithOfferPadding borderRadius18 ' :
                                        batteryVariant?.battery_kWh === comboBatteryVariants?.[1]?.battery_kWh ?
                                            'BatteryOnlyVariantBoxSelected BatteryVariantWithOfferPadding borderRadius18 ' :
                                            'BatteryOnlyVariantBox BatteryVariantWithOfferPadding borderRadius18'}
                                    onClick={() => {
                                        handleBatteryVariantChange(comboBatteryVariants?.[1]?.battery_kWh)
                                    }}
                                    disabled={batteryVariant?.battery_kWh != comboBatteryVariants?.[1]?.battery_kWh && quoteData.leadData.lead_status === "CONFIRM"}
                                >
                                    <div className="col-12 mt-11 text-center px-1 cursor-pointer">
                                        <div className="col-12 mt-11 text-center">
                                ...
                                <button className=
                                    {batteryVariant?.battery_kWh != comboBatteryVariants?.[2]?.battery_kWh && quoteData.leadData.lead_status === "CONFIRM" ?
                                        'BatteryOnlyVariantBoxDisabled BatteryVariantWithOfferPadding borderRadius18 ' :
                                        batteryVariant?.battery_kWh === comboBatteryVariants?.[2]?.battery_kWh ?
                                            'BatteryOnlyVariantBoxSelected BatteryVariantWithOfferPadding borderRadius18 ' :
                                            'BatteryOnlyVariantBox BatteryVariantWithOfferPadding borderRadius18'}
                                    onClick={() => {
                                        handleBatteryVariantChange(comboBatteryVariants?.[2]?.battery_kWh)
                                    }}
                                    disabled={batteryVariant?.battery_kWh != comboBatteryVariants?.[2]?.battery_kWh && quoteData.leadData.lead_status === "CONFIRM"}
                                >
                                    <div className="col-12 mt-11 text-center px-1 cursor-pointer">
                                        <div className="col-12 mt-11 text-center">
                        ...
                        <div className="col-6 comboImageWrapper position-relative ">
                            <div className="d-flex ml-5 flex-column logoImgDiv">
                                <div className="mb-2 iconNone">
                                    {/* Battery Brand Image For Mobile*/}
                                    <Image quality={100}
                                    ...
                                    >
                                        <div className="col-12 mt-11 text-center px-1 cursor-pointer">
                                            <div className="col-12 mt-11 text-center">
                                                ...
                                                <div className=
                                                    {batteryVariant?.battery_kWh != comboBatteryVariants?.[0]?.battery_kWh && quoteData.leadData.lead_status === "CONFIRM" ?
                                                        'font25Disable lineHeight22 mt-2' :
                                                        batteryVariant?.battery_kWh === comboBatteryVariants?.[0]?.battery_kWh ?
                                                            'font25Selected lineHeight22 mt-2' :
                                                            'font25 lineHeight22 mt-2'}>
                                                    {comboBatteryVariants?.[0]?.battery_kWh}KWh
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="col-5 combo1Icon">
                            <div className="d-flex flex-column align-items-start">
                                <div className="me-4 mb-5 mt-5">
                                    {/* Battery Brand Image For Desktop */}
                                    <Image quality={100}
                                        src={batteryVariant?.battery_brand_image?.path}
                                        alt="dasolarLogo"
